...
Crie um banco chamado `coisas_brasileiras` e rode **todas** as migrations em `migrations/`, na ordem numérica (hoje vai de `000_schema_inicial.sql` até `066_rls_tabelas_novas.sql`), com `psql` ou outro cliente de sua preferência:
